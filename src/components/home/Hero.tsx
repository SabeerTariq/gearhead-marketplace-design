    ...
    <div className="relative overflow-hidden bg-gradient-to-r from-oneoffautos-blue to-blue-900 py-16 md:py-24">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1494905998402-395d579af36f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="text-white">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in" style={{ animationDelay: "0.3s" }}>
              <Link to="/listings" className="group">
                <Button size="lg" className="bg-oneoffautos-red hover:bg-red-600 text-white px-8 py-6">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-xl animate-fade-in" style={{ animationDelay: "0.4s" }}>
            ...
            <div className="flex items-center">
              ...
              />
              <Link to="/listings" className="bg-oneoffautos-red hover:bg-red-600 transition-colors text-white px-4 py-3 rounded-r-lg flex items-center justify-center">
                <Search size={20} />
              </Link>
            </div>
